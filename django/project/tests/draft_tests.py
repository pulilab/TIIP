...
class ProjectDraftTests(SetupTests):
    ...
    def test_project_draft_merged_list(self):
        ...
        self.assertTrue("id" in response.json()['results'][0])
        self.assertTrue(response.json()['results'][0]["draft"])
        self.assertFalse(response.json()['results'][0]["published"])
        self.assertFalse(response.json()['results'][0]['public_id'])
        self.assertTrue("id" in response.json()['results'][1])
        self.assertTrue(response.json()['results'][1]["draft"])
        self.assertTrue(response.json()['results'][1]["published"])
        self.assertTrue(response.json()['results'][1]['public_id'])
        self.assertTrue("id" in response.json()['results'][2])
        self.assertTrue(response.json()['results'][2]["draft"])
        self.assertTrue(response.json()['results'][2]["published"])
        self.assertTrue(response.json()['results'][2]['public_id'])
